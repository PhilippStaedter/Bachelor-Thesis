...
def all_settings(iModel, iFile):
    ...
    if os.path.exists(BioModels_path + '/' + iModel):         #(benchmark_path + '/' + iModel):   #(BioModels_path + '/' + iModel)
        sim_start_time, sim_end_time, sim_num_time_points = timePointsBioModels(iModel)   #time_array = timePointsBenchmarkModels(iModel, iFile) #sim_start_time, sim_end_time, sim_num_time_points = timePointsBioModels(iModel)                 # call function from 'setTime_BioModels.py'
    else:
    ...
    model.setTimepoints(np.linspace(sim_start_time, sim_end_time, sim_num_time_points))                     #model.setTimepoints(time_array)      #(np.linspace(sim_start_time, sim_end_time, sim_num_time_points))
