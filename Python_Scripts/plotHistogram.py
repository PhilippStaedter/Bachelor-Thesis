...
plt.text(-5.5, 7.2, 'Simulation time distribution of models for different tolerance combinations', fontsize=titlesize - 5, fontweight='bold', transform=ax1.transAxes)  # -60 , 350
...
# save figure
#plt.savefig('../bachelor_thesis/New_Figures/Figures_study_2/Tolerances_Histogram_210SBML.pdf')
