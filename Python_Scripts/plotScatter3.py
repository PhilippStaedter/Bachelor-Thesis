...
for iCounter in range(0, 3):
    ...
    if iCounter == 0:
        ...
        leg2 = ax1.legend([str(round(len(all_intern_columns_1['state_variables']) * 100 / (166 * 20), 2)) + ' %'], loc=4)
        ax1.add_artist(leg1)
...
# save figure
#plt.savefig('../bachelor_thesis/New_Figures/Figures_study_4/Adams_vs_BDF_166SBML.pdf')
