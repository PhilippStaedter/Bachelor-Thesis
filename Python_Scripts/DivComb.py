...
# important paths
tsv_path = '../bachelor_thesis/SolverAlgorithm/Input_Output_Data_best_updated.tsv'
save_path = '../bachelor_thesis/SolverAlgorithm/Input_Output_Data_best_updated_divided.tsv'
