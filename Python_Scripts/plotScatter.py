...
for iCounter in range(0, int(len(linSol_files)/4)):
    ...
    if iCounter == 0:
        ...
        ax1.text(0.35, 1.05, 'linsol = DENSE', fontsize=fontsize + 4, fontweight='bold', transform=ax1.transAxes)
        ...
        ax1.text(0.35, 1.05, 'linsol = SPGMR', fontsize=fontsize + 4, fontweight='bold', transform=ax1.transAxes)
        #ax1.get_xaxis().set_visible(False)
        ...
        ax1.text(0.35, 1.05, 'linsol = SPBCG', fontsize=fontsize + 4, fontweight='bold', transform=ax1.transAxes)
        #ax1.get_xaxis().set_visible(False)
        ax1.tick_params(labelbottom=False)
        ax1.text(-0.12, 0.98, 'Simulation Time [ms]', fontsize=fontsize, fontweight='bold', transform=ax1.transAxes, rotation=rotation)
        ...
        ax1.text(0.35, 1.05, 'linsol = SPTFQMR', fontsize=fontsize + 4, fontweight='bold', transform=ax1.transAxes)
        #ax1.get_yaxis().set_visible(False)
        ax1.tick_params(labelleft=False)
        ...
        ax1.text(0.35, 1.05, 'linsol = KLU', fontsize=fontsize + 4, fontweight='bold', transform=ax1.transAxes)
        ax1.text(0.15, -0.3, 'Number of state variables', fontsize=titlesize, fontweight='bold', transform=ax1.transAxes)
        ax1.text(-0.12, 0.98, 'Simulation Time [ms]', fontsize=fontsize, fontweight='bold', transform=ax1.transAxes, rotation=rotation)
...
# set global labels
plt.text(0.1, 4, 'Simulation time distribution of models for different linear solver combinations', fontsize=titlesize, fontweight='bold', transform=ax1.transAxes)  # -60 , 350
...
# save figure
plt.savefig('../bachelor_thesis/New_Figures/Figures_study_3/NEW_NEW_LinearSolver.pdf')
